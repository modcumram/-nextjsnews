...
import { faAllergies, faBell } from "@fortawesome/free-solid-svg-icons"; 
...
const NavbarBackend = () => {
  ...
  useEffect(() => {
    ...
    setImgprofile(localStorage.getItem('img_profile'))
  }, [])
  ...
  return (
    <nav className="navbar navbar-expand navbar-light navbar-bg p-3">
      ...
      <div className="navbar-collapse collapse">
        <ul className="navbar-nav navbar-align">
              ...
              <div className="list-group">
                <a href="#" className="list-group-item">
                  <div className="row g-0 align-items-center">
                    <div className="col-2">
                    <FontAwesomeIcon icon={faAllergies} style={{fontSize: '24px'}} />
                    </div>
          ...
          <li className="nav-item dropdown">
            ...
            >
              <img
                src={"http://localhost/newsapi/public/images/profile/"+imgProfile}
